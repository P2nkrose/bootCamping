            ...
            <div class="card-body">
                <form method="get" enctype="multipart/form-data" >
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="customerid" class="form-control" value="${board.customerid}" readonly>
                    </div>
                ...
                <script>
                    ...
                    document.querySelector(".btn-success").addEventListener("click", function (e) {
                        frmView.action = "/customer/board/updateBoard";
                        frmView.method = "post";
                        frmView.submit();
                    });
                    ...
                    document.querySelector(".btn-danger").addEventListener("click", function (e) {
                        frmView.action = "/customer/board/deleteBoard";
                        frmView.method = "get";
                        frmView.submit();
                    });
