                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="/customer/board/getListBoard" method="get">
...
<%--                                        </div>--%>
                    ...
                    <table class="table" style="width: 1000px; margin: 0 auto">
                        ...
                        <c:forEach var="board" items="${responseDTO.dtoList}">
                            <tr>
                                <th scope="row">${no}</th>
                                <td>
                                    <a href="/customer/board/getOneBoard?boardid=${board.boardid}&${pageRequest.link}">${board.title}</a>
                                    <span class="badge progress-bar-success" style="background-color: #0a53be">${board.ripplecount}</span>
                                </td>
                                <td>${board.customerDTO.id}</td>
    ...
    <script>
        document.querySelector(".btn-success").addEventListener("click", function (e) {
            ...
            self.location = `/customer/board/addBoard`
        });
