	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<div id="requestPayment_form" class="box_section"
				...
				<div class="mb2">
					<label class="form-label" for="amount">금액 <span class="gray">(amount) <span
							class="red">필수</span></label>
					<input id="amount" class="form-control form-control-lg" type="text" value="15000">
					<!-- 금액 내 천단위 콤마 X -->
				</div>
...
<script>
	...
	paymentData["공통"] = {
		...
		"successUrl": "http://localhost:8080/customer/menu/paySuccess",
		"failUrl": "https://localhost:8080/customer/menu/payment",
		"windowTarget": "iframe",
		"taxFreeAmount": null,
